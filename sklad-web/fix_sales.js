  ...
  `<div className="overflow-y-auto flex-1 p-5 space-y-4">
          {isAdmin && (
            <div className="flex gap-2 pb-2 border-b border-slate-100 dark:border-slate-700">
              <button onClick={() => onDelete(sale.id)} className="flex items-center gap-1 px-3 py-1.5 text-sm text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-lg font-medium">
