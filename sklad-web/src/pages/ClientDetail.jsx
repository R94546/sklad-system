...
export default function ClientDetail() {
  ...
  const saleColumns = [
    { title: 'Sana', key: 'createdAt', render: (v) => <span className="text-xs text-gray-500">{new Date(v).toLocaleDateString()}</span> },
    ...
    { title: '', key: 'id', align: 'center', render: (v) => <a href={'/sales/' + v} className="text-blue-500 text-xs hover:underline">Ko'rish →</a> },
  ];
  ...
  const debtColumns = [
    ...
    { title: 'Muddat', key: 'dueDate', align: 'center', render: (v) => <span className="text-xs text-gray-500">{new Date(v).toLocaleDateString()}</span> },
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-4">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold text-gray-800 flex-1">{client.name}</h1>
      ...
      <div className="bg-white rounded-xl shadow-sm p-5">
        ...
        <div className="grid grid-cols-3 gap-4 pt-4 border-t">
          <div className="text-center">
            <p className="text-2xl font-bold text-blue-600">{client.sales?.length || 0}</p>
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        <div className="px-5 py-3 border-b bg-gray-50">
          <h2 className="font-semibold text-gray-700">Oxirgi xaridlar</h2>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        <div className="px-5 py-3 border-b bg-gray-50">
          <h2 className="font-semibold text-gray-700">Nasiyalar</h2>
        </div>
